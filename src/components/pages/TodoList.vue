...
export default {
  ...
  methods: {
    deleteItem(num) {
      axios({
        url: 'http://g2uy9t.natappfree.cc/task/delete',
        method: 'post',
        params: {
          userid: this.userid,
          taskid: num
    ...
    addItem() {
      ...
      if (msg === '') {
        ...
        axios({
          url: 'http://g2uy9t.natappfree.cc/task/add',
          method: 'post',
          params: {
            userid: this.userid,
            task_name: msg
    ...
    deleteFinished(tasks) {
      ...
      axios({
        url: 'http://g2uy9t.natappfree.cc/task/deleteall',
        method: 'post',
        params: {
          userid: this.userid,
          taskid: array
    ...
    addInfo(task) {
      axios({
        url: 'http://g2uy9t.natappfree.cc/task/update',
        method: 'post',
        params: {
          taskid: task.id,
