  ...
  <div>
    <div class="blog-box">
      <div class="blog-content">
        <div class="blog-author">契诃夫</div>
        <div class="blog-time">3小时前</div>
        <div class="blog-text">
          <h3 style="text-align: center;">变色龙</h3>
          <p>
          ...
          <p>“你竟敢咬人，该死的东西！”奥丘梅洛夫忽然听见说话声，“伙计们，别放走它！如今咬人可不行！抓住它！哎哟……哎哟！”</p>
          <p>
          ...
          <p>“这儿出了什么事？”奥丘梅洛夫挤到人群中去，问道，“你在这儿干什么？你干吗竖起手指头？……是谁在嚷？”</p>
          <p>
          ...
          <p>“少说废话！”</p>
          <p>“不，这条狗不是将军家的……”警察深思地说，“将军家里没有这样的狗。他家里的狗大半是大猎狗……”</p>
          <p>“你拿得准吗？”</p>
          <p>“拿得准，长官……”</p>
          <p>
      ...
      <div class="blog-content">
        <div class="blog-author">宇航Official</div>
        <div class="blog-time">9小时前</div>
        <div class="blog-text">速蛙云好像跑路啦，推特上都在骂！</div>
      </div>
      <div class="blog-content">
        <div class="blog-author">猪猪Official</div>
        <div class="blog-time">12小时前</div>
        <div class="blog-text">
          <p>
            照我自己想，虽然不是恶人，自从踹了古家的簿子，可就难说了。他们似乎别有心思，我全猜不出。况且他们一翻脸，便说人是恶人。我还记得大哥教我做论，无论怎样好人，翻他几句，他便打上几个圈；原谅坏人几句，他便说“翻天妙手，与众不同”。我那里猜得到他们的心思，究竟怎样；况且是要吃的时候。</p>
          <p>
      ...
      <div class="blog-content">
        <div class="blog-author">棒，约翰！</div>
        <div class="blog-time">15小时前</div>
        <div class="blog-text">更好的馅料，更好的披萨！</div>
      </div>
    </div>

    <div class="container fixed-bottom">
      <button type="button" class="btn btn-primary col-md-4 offset-md-4" data-bs-toggle="modal"
              data-bs-target="#blogModal">写点blog
      </button>
    </div>
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <textarea class="form-control" rows="10" id="blog-content" name="text"></textarea>
          </div>

          <!-- 模态框底部 -->
          <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">关闭</button>
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal">提交</button>
          </div>
