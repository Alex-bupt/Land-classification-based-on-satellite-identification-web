<template>
  <div>
    ...
    <div class="home position-relative">
      ...
      <button
        type="button"
        class="home-btn2 btn btn-outline-warning"
      ...
      <button
        type="button"
        class="home-btn btn btn-success"
        data-bs-toggle="modal"
        data-bs-target="#myRegister"
      >
        立 即 登 录
      </button>
    </div>
    ...
    <div
      id="mylogin"
      class="login modal fade"
      style="width: 600px; height: 650px; background-color: #ffffff"
    >
        ...
        <form class="was-validated">
          <div class="modal-content">
              ...
              <div class="login-container">
                <div class="form-floating mb-3 mt-3">
                  ...
                  <label for="username" class="form-label"
                    ><span class="loginred">*</span>用户名：</label
                  >
                ...
                <div class="mb-3 form-floating">
                  ...
                  <label for="pwd" class="form-label"
                    ><span class="loginred">*</span>密码：</label
                  >
                ...
                <div class="mb-3 mt-3 form-floating">
                  ...
                  <label for="email" class="form-label"
                    ><span class="loginred">*</span>电子邮件：</label
                  >
                  <div class="valid-feedback">有效</div>
            ...
            >
              <button
                type="button"
                class="btn btn-primary m-auto login-btn"
                @click="register"
